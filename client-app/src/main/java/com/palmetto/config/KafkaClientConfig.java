...
public class KafkaClientConfig {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<Long, OrderData> containerFactory(ConsumerFactory<Long, OrderData> consumerFactory) {
        ConcurrentKafkaListenerContainerFactory<Long, OrderData> factory = new ConcurrentKafkaListenerContainerFactory<>();
